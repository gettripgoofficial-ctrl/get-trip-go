...
export const kenyaArticleSeo: Record<string, string> = {
  ...
  "amboselis-last-super-tuskers":
    "What a super tusker actually is, where to find Amboseli's last great elephants against Kilimanjaro, and why so few remain today.",
  "lake-nakurus-flamingo-spectacle":
    "Why Lake Nakuru's flamingo numbers have changed in recent years, the best time to visit, and what else the park offers when the flock moves on.",
