...
import { kenyaTravelTips, kenyaJourneys } from "@/data/kenyaData"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-4">
            {kenyaJourneys.map(article => (
              <div key={article.id} className="cursor-pointer group">
                ...
                <p className="text-gray-800 font-bold text-base mt-1 mb-1 group-hover:text-yellow-600 transition-colors">
                  {article.title}
                </p>
