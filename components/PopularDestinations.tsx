...
const destinations = [
  ...
  },
  {
    ...
    country: "Thailand",
    price: "₹28,999",
    image: "https://images.unsplash.com/photo-1506665531195-3566af2b4dfa?w=800&q=90",
  },
  {
    name: "Kerala",
    country: "India",
  ...
  },
  {
    ...
    country: "Singapore",
    price: "₹42,999",
    image: "https://images.unsplash.com/photo-1525625293386-3f8f99389edd?w=800&q=90",
  },
  {
    name: "Kashmir",
    country: "India",
    price: "₹22,999",
    image: "https://images.unsplash.com/photo-1614094082869-cd4e4b2905c7?w=800&q=90",
  },
  {
    name: "Maldives",
    country: "Maldives",
  ...
  },
  {
    ...
    country: "Georgia",
    price: "₹45,999",
    image: "https://images.unsplash.com/photo-1565008576549-57569a49371d?w=800&q=90",
  },
  {
    name: "Bhutan",
    country: "Bhutan",
  ...
  },
  {
    ...
    country: "Vietnam",
    price: "₹29,999",
    image: "https://images.unsplash.com/photo-1528127269322-539801943592?w=800&q=90",
  },
  {
          ...
          {destinations.map(dest => (
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-3">
                ...
                <p className="text-yellow-400 text-xs font-semibold mt-1">From {dest.price}</p>
              </div>
            </Link>
          ))}
        </div>

        {/* Mobile: horizontal scroll, 2 cards fully visible */}
          ...
          {destinations.map(dest => (
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-2">
                ...
                <p className="text-yellow-400 text-[10px] font-semibold mt-0.5">From {dest.price}</p>
              </div>
            </Link>
          ))}
        </div>
