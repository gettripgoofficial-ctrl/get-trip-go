      ...
      <FieldRow>
        ...
        <div className="flex items-center px-3 flex-shrink-0">
          <button onClick={() => setShowModal(true)}
            className="flex items-center gap-2 px-5 h-[44px] bg-[#25D366] hover:bg-[#20bb5a] active:bg-[#1aad50] text-white text-[13px] font-bold rounded-[12px] transition-all hover:scale-[1.02] shadow-[0_4px_14px_rgba(37,211,102,0.35)] whitespace-nowrap">
            {WA_SVG} Get Best Hotel Deals
          </button>
        </div>
      </FieldRow>
